...
wordcloud::wordcloud(
  ...
  freq = sentiments$n,
  min.freq = 1, # Frecuencia mínima de las palabras para aparecer
  scale = c(3, 0.5), # Tamaño de las palabras (más grande a más pequeño)
  colors = brewer.pal(8, "Dark2"), # Paleta de colores
  random.order = FALSE
) # Para ordenar las palabras por frecuencia
```